...
- sim.txt: it defines all simulation settings. In particular, it sets the tool to inject single-bit sruck at 1 fault into the S-box circuit at the 29th clock cycle and single-bit sruck at 1 fault into the majority voting circuit at the 32th clock cycle.
